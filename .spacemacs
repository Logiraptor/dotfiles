...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(python
     ...
     javascript
     (lsp :variables
          lsp-file-watch-ignored-directories '("\bvendor/\b"))
     (go :variables
         go-backend 'lsp
...
before packages are loaded."
  ...
  (beacon-mode 1)
  (setq org-agenda-files '("~/Desktop/Drive/org/"))
  (setq org-todo-keywords
        (quote ((sequence "TODO(t)" "NEXT(n)" "WEEK(w)" "MONTH(m)" "|" "DONE(d)"))))
  ...
  (spacemacs/set-leader-keys "oa" '(lambda nil (interactive) (org-ql-view "Productivity")))
  (spacemacs/set-leader-keys "ot" '(lambda nil (interactive) (org-ql-view "Tags")))
  )
